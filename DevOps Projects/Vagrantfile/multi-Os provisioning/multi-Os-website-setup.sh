...
do
        echo $host
        sudo scp multi-os-website-setup.sh devops@$host:/home/devops/holder
        sudo ssh devops@$host cat /etc/hostname
        sudo ssh devops@$host chmod u+x multi-os-website-setup.sh
        sudo ssh devops@$host chown devops.devops multi-os-website-setup.sh
        sudo ssh devops@$host bash ./multi-os-website-setup.sh
        sudo ssh devops@$host rm -f multi-os-website-setup.sh
done
...
do
        ...
        sudo scp multi-os-website-setup.sh devops@$host:/home/devops/holder
        sudo ssh devops@$host cat /etc/hostname
        sudo ssh devops@$host chown devops.devops ~/devops/holder/multi-os-website-setup.sh
        sudo ssh devops@$host chmod u+x ~/devops/holder/multi-os-website-setup.sh
        sudo ssh devops@$host bash ./multi-os-website-setup.sh
        sudo ssh devops@$host rm -f ~/devops/holder/multi-os-website-setup.sh
done
